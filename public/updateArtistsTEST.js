...
function updateButtonClick() {
  ...
  req.open("GET", "http://flip1.engr.oregonstate.edu:8879/safeUpdateArtists?artistID=" + payloadArtistID + "&artistFirstName=" + payloadArtistFirstName + "&artistLastName=" + payloadArtistLastName, true);
  ...
  req.addEventListener('load', function () {
    ...
    if (req.status >= 200 && req.status < 400) { //if request send is good do this:
      ...
      window.location.replace("http://flip1.engr.oregonstate.edu:8879/artistsTEST");
